...
// {} represent an Object in JS
// let x = {a:3, b:55, c:undefined} // what is this in JS

// we may choose to pass in props for this component (inside a JS object)
function SubSection( {c} ) {
